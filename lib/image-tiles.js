...
function getPanoTileImages (id, zoom, tiles, _urlConstructor, _tileData) {
  getUrl = _urlConstructor ? _urlConstructor.getUrl : getUrl
  getTileData = _tileData ? _tileData.getTileData : getTileData
